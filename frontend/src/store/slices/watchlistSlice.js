...
export const addToWatchlist = createAsyncThunk('watchlist/addToWatchlist', async ({ userId, movieId, movieTitle, moviePoster }, { rejectWithValue }) => {
  try {
...
export const removeFromWatchlist = createAsyncThunk('watchlist/removeFromWatchlist', async ({ userId, movieId }, { rejectWithValue }) => {
  try {
    await api.delete(`/watchlist/${userId}/${movieId}`);
